...
if(isset($_POST['tambahdata'])) {
    if($modeaplikasi == "Demo") {
        ...
        $stmt = $mysqli->prepare("INSERT INTO kelembagaan (judul, isi) VALUES (?, ?)");
...
if(isset($_POST['simpan'])) {
    if($modeaplikasi == "Demo") {
        ...
        $stmt = $mysqli->prepare("UPDATE kelembagaan SET judul = ?, isi = ? WHERE id = ?");
...
if(isset($_POST['hapus'])) {
    if($modeaplikasi == "Demo") {
        ...
        $stmt = $mysqli->prepare("DELETE FROM kelembagaan WHERE id = ?");
...
<html lang="en">
    <head>
        <title><?php echo $rowpengaturanweb['namaweb'];?> &mdash; Kelembagaan</title>
        ...
        <div id="app">
            <div class="main-wrapper main-wrapper-1">
                ...
                <div class="main-content">
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive" style="overflow-x: hidden !important;">
                                                <table id="datatable" class="table display nowrap" width="100%" style="overflow-x: hidden !important;">
                                                    ...
                                                    <tbody>
                                                    <?php
                                                    $stmt = $mysqli->prepare("SELECT * FROM kelembagaan");
                                                    $stmt->execute();
                    ...
                    <?php
                    $stmtv321 = $mysqli->prepare("SELECT * FROM kelembagaan");
                    $stmtv321->execute();
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea class="form-control" style="height: 120px !important;" name="subjudul" required><?php echo $row321['isi'];?></textarea>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <div class="modal-content">
                                ...
                                <form action="" method="post" enctype="multipart/form-data" autocomplete="off">
                                    <div class="modal-body mb-0">
                                        ...
                                        <div class="form-group">
                                            <label>Deskripsi Lembaga</label>
                                            <textarea class="form-control" name="subjudul" placeholder="Masukkan isi informasi..." required></textarea>
                                        </div>
                                    </div>
                                    <div class="modal-footer pt-0 mt-0">
