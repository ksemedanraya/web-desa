...
if(isset($_POST['tambahdata'])) {
    if($modeaplikasi == "Demo") {
        ...
        $stmt = $mysqli->prepare("INSERT INTO pelayanan (judul, isi) VALUES (?, ?)");
...
if(isset($_POST['simpan'])) {
    if($modeaplikasi == "Demo") {
        ...
        $stmt = $mysqli->prepare("UPDATE pelayanan SET judul = ?, isi = ? WHERE id = ?");
...
if(isset($_POST['hapus'])) {
    if($modeaplikasi == "Demo") {
        ...
        $stmt = $mysqli->prepare("DELETE FROM pelayanan WHERE id = ?");
...
<html lang="en">
    <head>
        <title><?php echo $rowpengaturanweb['namaweb'];?> &mdash; Pusat Pelayanan</title>
        ...
        <div id="app">
            <div class="main-wrapper main-wrapper-1">
                ...
                <div class="main-content">
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive" style="overflow-x: hidden !important;">
                                                <table id="datatable" class="table display nowrap" width="100%" style="overflow-x: hidden !important;">
                                                    ...
                                                    <tbody>
                                                    <?php
                                                    $stmt = $mysqli->prepare("SELECT * FROM pelayanan");
                                                    $stmt->execute();
                    ...
                    <?php
                    $stmtv321 = $mysqli->prepare("SELECT * FROM pelayanan");
                    $stmtv321->execute();
