...
if(isset($_GET['id'])) {
    ...
    $stmtvq2 = $mysqli->prepare("SELECT * FROM potensidesa WHERE id = ?");
            ...
            <div class="row">
                <div class="col-lg-8 mb-md-0 mb-3">
                    <div class="blog-details-text-area details-text-area">    
                        <img src="uploads/<?php echo $rowvq2['foto'];?>" class="w-100 mb-3" alt="<?php echo $rowvq2['judul'];?>" title="<?php echo $rowvq2['judul'];?>">                    
                ...
                <div class="col-lg-4">
                    <div class="sidebar-area pl-20">
                        <div class="sidebar-card sidebar-category">
                            ...
                            <ul>
                                <?php
                                $stmtv2 = $mysqli->prepare("SELECT * FROM potensidesa");
                                $stmtv2->execute();
                                $resultv2 = $stmtv2->get_result();
                                if($resultv2->num_rows === 0) {?>
                                    <li><a href="#">Belum Ada Potensi Desa</a></li>
                                <?php } else { while($rowv2 = $resultv2->fetch_assoc()) {?>
                                    <li><a href="lihatpotensi?id=<?php echo $rowv2['id'];?>"><i class="fas fa-angle-right"></i> <?php echo $rowv2['judul'];?></a></li>
                                <?php } }?>
                            </ul>
                        </div>
                    </div>
