...
if(isset($_GET['id'])) {
    ...
    $stmtvq2 = $mysqli->prepare("SELECT * FROM kelembagaan WHERE id = ?");
                ...
                <div class="col-lg-4">
                    <div class="sidebar-area pl-20">
                        <div class="sidebar-card sidebar-category">
                            ...
                            <ul>
                                <?php
                                $stmtv2 = $mysqli->prepare("SELECT * FROM kelembagaan");
                                $stmtv2->execute();
                                $resultv2 = $stmtv2->get_result();
                                if($resultv2->num_rows === 0) {?>
                                    <li><a href="#">Belum Ada Lembaga</a></li>
                                <?php } else { while($rowv2 = $resultv2->fetch_assoc()) {?>
                                    <li><a href="lihatlembaga?id=<?php echo $rowv2['id'];?>"><i class="fas fa-angle-right"></i> <?php echo $rowv2['judul'];?></a></li>
                                <?php } }?>
                            </ul>
                        </div>
                    </div>
